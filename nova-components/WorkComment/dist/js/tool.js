...
Nova.booting(function (Vue, router) {
    Vue.component('work-comment', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        axios.get('/nova-vendor/work-comment/' + this.resourceId + '?resource=' + this.resourceName).then(function (response) {
            if (response.data.length) {
                _this.records = response.data;

                if (_this.resourceName == 'comments') {
                    _this.work_id = response.data[0].work_id;
                }
            }

            if (_this.resourceName == 'works') {
                _this.work_id = _this.resourceId;
            }
...
var render = function() {
  ...
  return _c(
    ...
    [
        ...
        [
          this.resourceName == "comments"
            ? _c(
                "a",
                {
                  ...
                  attrs: { href: "/admin/resources/works/" + _vm.work_id }
                },
                [_vm._v("返回工单详情")]
              )
            : _vm._e(),
          ...
          _c(
            "a",
            {
              ...
              attrs: {
                href:
                  "/admin/resources/comments/new?viaResource=works&viaResourceId=" +
                  _vm.work_id +
      ...
      _vm._v(" "),
      _vm._l(_vm.records, function(messageList) {
        return _c("div", { staticStyle: { clear: "both" } }, [
          messageList.right == false
            ? _c("div", [
                _c("div", { staticClass: "pc-service" }, [
                  _c("div", { staticClass: "pc-service-right" }, [
                    _c("p", [
                      _c("label", [_vm._v(_vm._s(messageList.user_name))]),
                      _c("span", [_vm._v(_vm._s(messageList.created_at))])
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "pc-service-info" }, [
                      _c("div", {
                        domProps: { innerHTML: _vm._s(messageList.content) }
                      })
                    ])
                  ])
                ])
            ...
            : _c("div", [
                _c("div", { staticClass: "pc-customer" }, [
                  _c("p", [
                    _c("label", [_vm._v(_vm._s(messageList.user_name))]),
                    _c("span", [_vm._v(_vm._s(messageList.created_at))])
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "pc-customer-info" }, [
                    _c("div", {
                      domProps: { innerHTML: _vm._s(messageList.content) }
                    })
                  ])
